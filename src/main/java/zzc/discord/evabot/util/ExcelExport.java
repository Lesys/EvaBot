...
public final class ExcelExport {
	 ...
	 */
	public static void exportTeamStringBuilder(TeamDTO team) {
		team.getFullPlayerList().forEach(
	 ...
	 * @throws IOException
	 */
	public static void exportLobby(String lobbyName, List<TeamDTO> teams, @NotNull MessageReceivedEvent event) throws IOException {
